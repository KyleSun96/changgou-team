package com.changgou.web.center.utils;
...
public class DateUtils {
    //6-2中的日期控件专用
    public static List<String> getBetweenDaysByStartAndEndDate(String start,String end) throws Exception{
        ...
        //计算起始中间的每一天
        calendar.add(Calendar.DATE,-betweenDays);//获得当前时间往前推betweenDays天
        for(int i=0;i<betweenDays;i++){
            calendar.add(Calendar.DATE,1);//获得当前时间往后推一天
