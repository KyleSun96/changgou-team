$.fn.address = function (eleName1, eleName2, eleName3) {
	let ele1 = $(this).find(eleName1);
	let ele2 = $(this).find(eleName2);
	let ele3 = $(this).find(eleName3);
	let tempCityObject = provinceList[0];
	let tempdistrictObject = tempCityObject.cityList[0];
	$.each(provinceList, function (index, item) {
		ele1.append("<option>" + item.name + "</option>")
	})
	ele2Rander();
	ele3Rander();
	ele1.change(function () {
		$.each(provinceList, function (index, item) {
			if (item.name == ele1.val()) {
				tempCityObject = item;
				ele2Rander()
				ele3Rander()
				return;
	...
	ele2.change(function () {
		$.each(tempCityObject.cityList, function (index, item) {
			if (item.name == ele2.val()) {
				tempdistrictObject = item;
				ele3Rander();
				return;
			}
		})
	...
	function ele2Rander() {
		ele2.empty();
		$.each(tempCityObject.cityList, function (index, item) {
			ele2.append("<option>" + item.name + "</option>")
		})

	}
	function ele3Rander() {
		ele3.empty();
		$.each(tempdistrictObject.areaList, function (index, item) {
			ele3.append("<option>" + item + "</option>")
		})
	}
}

$(function () {
	$(".address").address(".province1", ".city1", ".district1");
	$(".editAddressInfo").address(".province1", ".city1", ".district1");
